    ...
    <div className='grid md:grid-cols-2 sm:grid-cols-1 gap-x-20 mt-20 sm:gap-y-16 md:gap-y-0'>
      ...
      <div className='pb-6'>
        ...
        <div className='flex-col sm:w-full justify-center'>
          <div className='bg-gray-100 shadow-md box-border mb-4 transition-colors duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg py-2 sm:h-auto w-auto'>
            <a href="https://booknote.substack.com/" className='flex justify-center items-center'>
              <div className='text-3xl m-4'>📚</div>
              <div className='m-2 hover:text-gray-600'>
                <h1 className='font-bold text-lg font-sans'>Book Note Newsletter</h1>
                <p className="text-sm">
          ...
          <div className='bg-gray-100 shadow-md box-border mb-4 transition-colors duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg py-2 sm:h-auto w-auto'>
            <a href="https://mlboss.substack.com/" className='flex justify-center items-center'>
              <div className='text-3xl m-4'>🧠</div>
              <div className='m-2 hover:text-gray-600'>
                <h1 className='font-bold text-lg font-sans'>AI related Newsletter</h1>
                <p className="text-sm">
                  Lorem ipsum dolor sit amet consectetur elit lor Lorem ipsum
                  dolor sit amet consectetur..
                </p>
          ...
          <div className='bg-gray-100 shadow-md box-border mb-4 transition-colors duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg py-2 sm:h-auto w-auto'>
            <a href="/coursera" className='flex justify-center items-center'>
              <div className='text-3xl m-4'>🏆</div>
              <div className='m-2 hover:text-gray-600'>
                <h1 className='font-bold text-lg font-sans'>Coursera Certificate</h1>
                <p className="text-sm">
                  Lorem ipsum dolor sit amet consectetur elit lor Lorem ipsum
                  dolor sit amet consectetur..
                </p>
      ...
      <div className='pb-5'>
        ...
        <div className='flex-col sm:w-full justify-center'>
          <div className='sm:h-auto w-auto'>
            <div className='flex justify-center items-center '>
              <div className='mx-2 mb-2'>
                <h1 className='font-semibold text-lg text-gray-600 font-sans'>📃My Resume Template</h1>
          ...
          <div className='sm:h-auto w-auto'>
            <a href="https://books2read.com/u/bpyW0k" className='flex justify-center items-center'>
              <div className='m-2'>
                <h1 className='font-semibold text-lg text-gray-600 font-sans'>📘My Object Detection Book</h1>
                <p className="text-sm text-gray-800 hover:text-gray-500 pb-2">
                  Lorem ipsum dolor sit amet consectetur elit lor Lorem ipsum
                  dolor sit amet consectetur..
                </p>
          ...
          <div className='sm:h-auto w-auto'>
            <div className='flex justify-center items-center'>
              <div className='m-2'>
                <h1 className='font-semibold text-lg text-gray-600 font-sans'>📒Knowledge Database Notion Template</h1>
                <p className="text-sm text-gray-800 hover:text-gray-500 pb-2">
                  Lorem ipsum dolor sit amet consectetur elit lor Lorem ipsum
                  dolor sit amet consectetur..
                </p>
