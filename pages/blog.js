...
// const Blog = () => {
//   const [currentBlogs, setCurrentBlogs] = React.useState(blogData.slice(0, 2));
...
//         <div className='md:mx-0 mx-5 rounded-lg cursor-pointer border-box border-0  my-5 overflow-hidden shadow-md md:w-auto sm:w-[280px]' key={blog.id}>
//           <div className="justify-center">
//                   <img className="h-[200px] w-full" src={blog.image} alt={blog.title} />
//                 </div>
//                 <div className="bg-blue-400 h-[126px] ">
//                 <div className=' mx-4 mb-4'>
//                 <h2 className='text-md font-bold'>{blog.title}</h2>
//                 <h2>{blog.description}</h2>
//                 </div>
...
//         <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleShowMore}>
//           Show More
//         </button>
//       }
//     </div>
